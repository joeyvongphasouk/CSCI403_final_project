...
-- primary key it based on the object id, is distinct across all rows
ALTER TABLE f23_group20.clean_traffic
ADD CONSTRAINT clean_traffic_pk PRIMARY KEY (offense_id);
